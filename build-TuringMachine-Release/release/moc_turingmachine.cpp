...
QT_MOC_LITERAL(1, 14, 18), // "on_pushBtn_clicked"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 17) // "on_DisBtn_clicked"

    },
    "TuringMachine\0on_pushBtn_clicked\0\0"
    "on_DisBtn_clicked"
};
...
void TuringMachine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TuringMachine *_t = static_cast<TuringMachine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_pushBtn_clicked(); break;
...
const QMetaObject TuringMachine::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_TuringMachine.data,
      qt_meta_data_TuringMachine,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TuringMachine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TuringMachine.stringdata0))
        return static_cast<void*>(const_cast< TuringMachine*>(this));
